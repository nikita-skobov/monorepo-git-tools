# These test(s) are the 'gold standard' of testing
# gitfilter capabilities by comparing filtering of
# a complicated repository such as react. Unfortunately
# it is difficult to support this right off the bat because
# there are too many edge cases to consider at once, so it's easier
# to do test cases for simpler things one at a time...
# eventually id like to run this test, but not right now...
